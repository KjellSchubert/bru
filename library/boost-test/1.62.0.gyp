    ...
    "targets": [
        {
            ...
            "type": "static_library",
            "include_dirs": [
                "1.62.0/test-boost-1.62.0/include",
                "1.62.0/type_index-boost-1.62.0/include",
                "../boost-algorithm/1.62.0/algorithm-boost-1.62.0/include"
            ...
            "sources": [
                "1.62.0/test-boost-1.62.0/src/*.cpp"
            ],
            ...
            # the duplicate main().
            "sources!": [
                "1.62.0/test-boost-1.62.0/src/cpp_main.cpp"
            ],
            "dependencies": [
        ...
        },
        {
            ...
            #"test": {},
            "sources": [
                "1.62.0/test-boost-1.62.0/example/unit_test_example_01.cpp"
            ],
...

        {
            ...
            "test": {
                ...
                "cwd": "1.62.0/test-boost-1.62.0/test"
            },
            "sources": [
                "1.62.0/test-boost-1.62.0/test/result_report_test.cpp"
            ],
            "dependencies": [ "boost-test" ],
                # this disables building the example on iOS
                "conditions": [
        ...
        
        {
            ...
            "test": {},
            "sources": [
                "1.62.0/test-boost-1.62.0/test/algorithms_test.cpp"
            ],
            "dependencies": [ "boost-test" ],
            # this disables building the example on iOS
            "conditions": [
...

        {
            ...
            "test": {},
            "sources": [
                "1.62.0/test-boost-1.62.0/test/test_case_template_test.cpp"
            ],
            "dependencies": [ "boost-test" ],
            # this disables building the example on iOS
            "conditions": [
