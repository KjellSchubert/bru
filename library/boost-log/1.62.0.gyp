    ...
    "targets": [
        {
            ...
            "type": "static_library",
            "include_dirs": [
                "1.62.0/log-boost-1.62.0/include"
            ],
            ...
            "defines": [
                # TODO: see http://www.boost.org/doc/libs/1_62_0/libs/log/doc/html/log/installation/config.html
                # e.g. the regex vs xpressive choice
            ],
            "sources": [
                "1.62.0/log-boost-1.62.0/src/*.cpp"
            ],
            "sources!": [
                # is this Windows-only?
                "1.62.0/log-boost-1.62.0/src/debug_output_backend.cpp",
                "1.62.0/log-boost-1.62.0/src/event_log_backend.cpp",
                # not compiling
                "1.62.0/log-boost-1.62.0/src/dump_avx2.cpp",
                "1.62.0/log-boost-1.62.0/src/dump_ssse3.cpp",
                "1.62.0/log-boost-1.62.0/src/init_from_settings.cpp"
            ],
            "dependencies": [
        ...
        #    "type": "executable",
        #    "test": {},
        #    "sources": [ "1.62.0/log-boost-1.62.0/test/foooo.cpp" ],
