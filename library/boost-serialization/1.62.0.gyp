    ...
    "targets": [
        {
            ...
            "type": "static_library",
            "include_dirs": [
                "1.62.0/serialization-boost-1.62.0/include"
            ],
            ...
            "sources": [
                "1.62.0/serialization-boost-1.62.0/src/*.cpp"
            ],
            "sources!": [
                # See http://lists.boost.org/Archives/boost/2014/08/216436.php,
                # this file is excluded from build now.
                "1.62.0/serialization-boost-1.62.0/src/shared_ptr_helper.cpp"
            ],
            "dependencies": [
        ...
        #    "type": "executable",
        #    "test": {},
        #    "sources": [ "1.62.0/serialization-boost-1.62.0/test/test_unique_ptr.cpp" ],
...

        {
            ...
            "test": {},
            "sources": [
                "1.62.0/serialization-boost-1.62.0/example/demo_portable_archive.cpp",
                "1.62.0/serialization-boost-1.62.0/example/portable_binary_oarchive.cpp",
                "1.62.0/serialization-boost-1.62.0/example/portable_binary_iarchive.cpp"
            ],
            "dependencies": [ "boost-serialization"],
