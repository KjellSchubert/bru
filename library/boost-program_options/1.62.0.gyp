    ...
    "targets": [
        {
            ...
            "type": "static_library",
            "include_dirs": [
                "1.62.0/program_options-boost-1.62.0/include"
            ],
            ...
            "sources": [
                "1.62.0/program_options-boost-1.62.0/src/*.cpp"
            ],
            "dependencies": [
        ...
        },
        {
            ...
            "test": {},
            "sources": [
                "1.62.0/program_options-boost-1.62.0/test/positional_options_test.cpp"
            ],
