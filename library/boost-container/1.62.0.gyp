    ...
    "targets": [
        {
            ...
            "type": "none",
            "include_dirs": [
                "1.62.0/container-boost-1.62.0/include"
            ],
            ...
            "sources": [
                ...
                # "1.62.0/container-boost-1.62.0/src/dlmalloc_ext_2_8_6.c"
            ],
            "dependencies": [
        ...
        #    "type": "executable",
        #    "test": {},
        #    "sources": [ "1.62.0/container-boost-1.62.0/test/vector_test.cpp" ],
        ...
        #},
        {
            ...
            "type": "executable",
            "test": {},
            "sources": [ "1.62.0/container-boost-1.62.0/test/string_test.cpp" ],
            "dependencies": [
                "boost-container"
            ],
