    ...
    "targets": [
        {
            ...
            "type": "none",
            "include_dirs": [
                "1.62.0/multi_index-boost-1.62.0/include"
            ],
        ...
        },
        {
            ...
            "test": {},
            "sources": [ 
                "1.62.0/multi_index-boost-1.62.0/test/test_basic.cpp",
                "1.62.0/multi_index-boost-1.62.0/test/test_basic_main.cpp" 
            ],
        ...
        },
        {
            ...
            "test": {},
            "sources": [ 
                "1.62.0/multi_index-boost-1.62.0/example/basic.cpp" 
            ],
            "dependencies": [ "boost-multi_index" ],
            # this disables building the example on iOS
            "conditions": [
