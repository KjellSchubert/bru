    ...
    "targets": [
        {
            ...
            "type": "static_library",
            "include_dirs": [
                "1.62.0/filesystem-boost-1.62.0/include"
            ],
            ...
            "sources": [
                "1.62.0/filesystem-boost-1.62.0/src/*.cpp"
            ],
            "dependencies": [
        ...
        },
        {
            ...
            "type": "executable",
            "test": { "cwd": "1.62.0/filesystem-boost-1.62.0/test" },
            "sources": [
                "1.62.0/filesystem-boost-1.62.0/test/fstream_test.cpp"
            ],
            "dependencies": [
                "boost-filesystem"
            ],
        ...
        },
        {
            ...
            "test": { "cwd": "1.62.0/filesystem-boost-1.62.0/test" },
            "sources": [
                "1.62.0/filesystem-boost-1.62.0/test/path_test.cpp"
            ],
            "dependencies": [
                "boost-filesystem"
