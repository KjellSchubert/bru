    ...
    "targets": [
        {
            ...
            "type": "static_library",
            "include_dirs": [
                "1.62.0/context-boost-1.62.0/include"
            ],
            ...
            "sources": [
                ...
                #"1.62.0/context-boost-1.62.0/src/*.cpp"
            ...
            "conditions": [
                ["OS=='win'", {
                    "sources": [
                        # 32bit windows
                        "1.62.0/context-boost-1.62.0/src/asm/jump_i386_ms_pe_masm.asm",
                        "1.62.0/context-boost-1.62.0/src/asm/make_i386_ms_pe_masm.asm"
                        # this here would be 64bit windows:
                        #"1.62.0/context-boost-1.62.0/src/asm/jump_x86_64_ms_pe_masm.asm",
                        #"1.62.0/context-boost-1.62.0/src/asm/make_x86_64_ms_pe_masm.asm"
                    ]
                }], 
                ["OS=='mac'", {
                    "sources": [
                        "1.62.0/context-boost-1.62.0/src/asm/jump_x86_64_sysv_macho_gas.S",
                        "1.62.0/context-boost-1.62.0/src/asm/make_x86_64_sysv_macho_gas.S"
                    ]
                }], 
                ["OS=='iOS'", {
                    "sources": [
                        "1.62.0/context-boost-1.62.0/src/dummy.cpp"
                    ]
                }], 
                ...
                ["OS=='linux'", {
                    "sources": [
                        # 64bit elf
                        "1.62.0/context-boost-1.62.0/src/asm/jump_x86_64_sysv_elf_gas.S",
                        "1.62.0/context-boost-1.62.0/src/asm/make_x86_64_sysv_elf_gas.S"
                        # this here would be 32bit elf:
                        #"1.62.0/context-boost-1.62.0/src/asm/jump_i386_sysv_elf_gas.S",
                        #"1.62.0/context-boost-1.62.0/src/asm/make_i386_sysv_elf_gas.S"
                    ]
                }]
            ],
            "dependencies": [
        ...
        },
        {
            ...
            "type": "executable",
            "test": {},
            "sources": [ "1.62.0/context-boost-1.62.0/test/test_context.cpp" ],
            "dependencies": [
                "boost-context",
        ...
        },
        {
            ...
            "type": "executable",
            "test": {},
            "sources": [ "1.62.0/context-boost-1.62.0/example/transfer.cpp" ],
            "dependencies": [
                "boost-context",
                "../boost-assert/boost-assert.gyp:*",
                "../boost-array/boost-array.gyp:*"
