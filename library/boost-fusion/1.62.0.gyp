    ...
    "targets": [
        {
            ...
            "type": "none",
            "include_dirs": [
                "1.62.0/fusion-boost-1.62.0/include"
            ],
        ...
        #    "type": "executable",
        #    "test": {},
        #    "sources": [ "1.62.0/fusion-boost-1.62.0/test/functional/invoke.cpp" ],
        ...
        #}
        {
            ...
            "type": "executable",
            "test": {},
            "sources": [ "1.62.0/fusion-boost-1.62.0/test/functional/make_fused.cpp" ],
            "dependencies": [ "boost-fusion"],
