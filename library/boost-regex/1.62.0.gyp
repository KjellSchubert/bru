    ...
    "targets": [
        {
            ...
            "type": "static_library",
            "include_dirs": [
                "1.62.0/regex-boost-1.62.0/include"
            ],
            #"defines": [
            ...
            "sources": [
                "1.62.0/regex-boost-1.62.0/src/*.cpp"
            ],
            "dependencies": [
        ...
        #    "type": "executable",
        #    "sources": [
        #        "1.62.0/regex-boost-1.62.0/test/captures/captures_test.cpp"
        #    ],
        #    "dependencies": [
        #        "boost-regex"
        #    ]
        #}        
          {
            ...
            "type": "executable",
            "test": {
                "cwd": "1.62.0/regex-boost-1.62.0/example/snippets",
                "args": [ "regex_grep_example_3.cpp" ] # any file defining some classes will do
            },
            "sources": [
                "1.62.0/regex-boost-1.62.0/example/snippets/regex_grep_example_3.cpp"
            ],
